...
%path_25km=strcat(path,'am4p0_8x160_4K_nocgdrag/','19790101');
path_25km=strcat(path,'c96L33_am4p0_8x160_nh_25km_wlkr_4K_c/','19790101');
...
liq_25km_zmn_last10m=liq_25km_zmn(:,:,2:12);
...
hur_25km_zmn_last10m=hur_25km_zmn(:,:,2:12);
...
%p_25km_8x_znm=p_25km_8x_znm(:,4800:2920);
% time mean precip
p_25km_8x_znm_equil=p_25km_8x_znm(:,481:2920);
...
clt_25km_znm_2m=clt_25km_znm(:,:,31:360);
...
w_25km_zmn_tmn_last11=squeeze(w_25km_zmn(:,:,21:364));
w_25km_zmn_tm=squeeze(mean(w_25km_zmn_tmn_last11,3));
...
yt=get(gca,'YTick');
set(gca,'FontSize',16)
tit_e=strcat('Time Mean Precip',tit_st);
title(tit_e)
...
clabel(C,h,v);
tit_a=strcat('liq+ice water 2km',tit_st)
title(tit_a)
set(gca,'Ydir','reverse')
colorbar
subplot(1,2,2)
...
clabel(C,h,v);
tit_b=strcat('liq+ice 25km',tit_st)
title(tit_b)
set(gca,'Ydir','reverse')
colorbar
...
v=[10,20,30,50,70];
clabel(C,h,v);
tit_a=strcat('relative humidity 2km',tit_st)
title(tit_a)
%set(gca,'Ydir','reverse')
%colorbar
hold on
...
clabel(C,h,v);
tit_b=strcat('relative humidity 25km',tit_st)
title(tit_b)
set(gca,'Ydir','reverse')
colorbar
