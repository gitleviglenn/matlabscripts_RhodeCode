...
figure
plot(squeeze(rad_heat_mat(1,1,:)),pfull_2km);
set(gca,'Ydir','reverse')
hold on
plot(squeeze(rad_heat_mat(2,1,:)),pfull_2km);
plot(squeeze(rad_heat_mat(3,1,:)),pfull_2km);
plot(squeeze(rad_heat_mat(4,1,:)),pfull_2km);
plot(squeeze(rad_heat_mat(5,1,:)),pfull_2km);
