...
%toa_net_cre2_array=zeros(nmonths,nlat,nlon,6);
...
toa_lw_cre_array(:,:,:,1)=olr_ts(perst:perend,:,:)-olr_clr_ts(perst:perend,:,:);
...
toa_sw_cre_array(:,:,:,1)=swup_ts(perst:perend,:,:)-swup_clr_ts(perst:perend,:,:);
...
toa_net_cre_array(:,:,:,1)=toa_sw_cre_array(:,:,:,1)+toa_lw_cre_array(:,:,:,1);
%toa_net_cre2_array(:,:,:,1)=-toa_net_clr_rflux_array(:,:,:,1)+toa_net_rflux_array(:,:,:,1);
...
toa_lw_cre_array(:,:,:,2)=olr_ts(perst:perend,:,:)-olr_clr_ts(perst:perend,:,:);
...
toa_sw_cre_array(:,:,:,2)=swup_ts(perst:perend,:,:)-swup_clr_ts(perst:perend,:,:);
...
toa_net_cre_array(:,:,:,2)=toa_sw_cre_array(:,:,:,2)+toa_lw_cre_array(:,:,:,2);
%toa_net_cre2_array(:,:,:,2)=-toa_net_clr_rflux_array(:,:,:,2)+toa_net_rflux_array(:,:,:,2);
...
toa_lw_cre_array(:,:,:,3)=olr_ts(perst:perend,:,:)-olr_clr_ts(perst:perend,:,:);
...
toa_sw_cre_array(:,:,:,3)=swup_ts(perst:perend,:,:)-swup_clr_ts(perst:perend,:,:);
...
toa_net_cre_array(:,:,:,3)=toa_sw_cre_array(:,:,:,3)+toa_lw_cre_array(:,:,:,3);
%toa_net_cre2_array(:,:,:,3)=-toa_net_clr_rflux_array(:,:,:,3)+toa_net_rflux_array(:,:,:,3);
...
toa_lw_cre_array(:,:,:,4)=olr_ts(perst:perend,:,:)-olr_clr_ts(perst:perend,:,:);
...
toa_sw_cre_array(:,:,:,4)=swup_ts(perst:perend,:,:)-swup_clr_ts(perst:perend,:,:);
...
toa_net_cre_array(:,:,:,4)=toa_sw_cre_array(:,:,:,4)+toa_lw_cre_array(:,:,:,4);
%toa_net_cre2_array(:,:,:,4)=-toa_net_clr_rflux_array(:,:,:,4)+toa_net_rflux_array(:,:,:,4);
...
toa_lw_cre_array(:,:,:,5)=olr_ts(perst:perend,:,:)-olr_clr_ts(perst:perend,:,:);
...
toa_sw_cre_array(:,:,:,5)=swup_ts(perst:perend,:,:)-swup_clr_ts(perst:perend,:,:);
...
toa_net_cre_array(:,:,:,5)=toa_sw_cre_array(:,:,:,5)+toa_lw_cre_array(:,:,:,5);
%toa_net_cre2_array(:,:,:,5)=-toa_net_clr_rflux_array(:,:,:,5)+toa_net_rflux_array(:,:,:,5);
...
fout=strcat('am2_ensmn_',temptype,'_',tperiod,'_pdown.nc');
%file_out='am2_ensmn_tref_early_pdown.nc';
file_out=fout;
ensmn_write_ncout
%
fout=strcat('am2_trends_',temptype,'_',tperiod,'_pdown.nc');
%file_out='am2_trends_tref_early_pdown.nc';
file_out=fout;
...
%toa_net_cre2_array=zeros(nmonths,nlat,nlon,5);
...
%
fout=strcat('am3_ensmn_',temptype,'_',tperiod,'_pdown.nc');
file_out=fout;
%file_out='am3_ensmn_tref_early_pdown.nc';
ensmn_write_ncout
%
fout=strcat('am3_trends_',temptype,'_',tperiod,'_pdown.nc');
file_out=fout;
%file_out='am3_trends_tref_early_pdown.nc';
compute_write_trends
trends_write_ncout
%%---------------------------------------------------------------------------------
%% done with AM3
...
fout=strcat('am4_ensmn_',temptype,'_',tperiod,'_pdown.nc');
file_out=fout;
%file_out='am4_ensmn_tref_early_pdown.nc';
ensmn_write_ncout

fout=strcat('am4_trends_',temptype,'_',tperiod,'_pdown.nc');
file_out=fout;
%file_out='am4_trends_tref_early_pdown.nc';
compute_write_trends
trends_write_ncout
%---------------------------------------------------------------------------------
% done with AM4
