...
% for am3
plot(timearr(starti:endi),alpha_lcc_array_am3(starti:endi,1),'r')
hold on
plot(timearr(starti:endi),alpha_lcc_array_am3(starti:endi,2),'r')
plot(timearr(starti:endi),alpha_lcc_array_am3(starti:endi,3),'r')
plot(timearr(starti:endi),alpha_lcc_array_am3(starti:endi,4),'r')
plot(timearr(starti:endi),alpha_lcc_array_am3(starti:endi,5),'r')
% ensemble mean
plot(timearr(starti:endi),mean_alpha_lcc_am3(starti:endi),'r','Linewidth',3)

% for am2
plot(timearr(starti:endi),alpha_lcc_array(starti:endi,1),'b')
plot(timearr(starti:endi),alpha_lcc_array(starti:endi,2),'b')
plot(timearr(starti:endi),alpha_lcc_array(starti:endi,3),'b')
plot(timearr(starti:endi),alpha_lcc_array(starti:endi,4),'b')
plot(timearr(starti:endi),alpha_lcc_array(starti:endi,5),'b')
%plot(timearr(starti:endi),alpha_lcc_array(starti:endi,6),'b') 
% ensemble mean
plot(timearr(starti:endi),mean_alpha_lcc(starti:endi),'b','Linewidth',3)

% for am4
plot(timearr(starti:endi),alpha_lcc_array_am4(starti:endi,1),'k')
plot(timearr(starti:endi),alpha_lcc_array_am4(starti:endi,2),'k')
plot(timearr(starti:endi),alpha_lcc_array_am4(starti:endi,3),'k')
plot(timearr(starti:endi),alpha_lcc_array_am4(starti:endi,4),'k')
plot(timearr(starti:endi),alpha_lcc_array_am4(starti:endi,5),'k')
% ensemble mean
...
corrcoef(mean_alpha,mean_alpha_lcc)
corrcoef(mean_alpha_am3,mean_alpha_lcc_am3)
corrcoef(mean_alpha_am4,mean_alpha_lcc_am4)
