% script optained from http://romps.berkeley.edu/pubs/pubs-2016-lcl.html
%
...
%
% Since MATLAB does not allow optional input variables or default values
% for input variables, this function has been written to only allow the 
% input of rhl.  If you like unsolicited advice, do not use MATLAB.  R
% and Python are free and better.

function z = lcl_romps(p,T,rhl,return_ldl,return_min_lcl_ldl)
